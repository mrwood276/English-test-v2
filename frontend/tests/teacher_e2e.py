...
with sync_playwright() as pw:
    ...
    check("dashboard and question bank are available, the rest are marked soon", len(page.query_selector_all(".nav span.item")) == 3 and len(page.query_selector_all(".nav a")) == 2)
