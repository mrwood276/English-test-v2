...
with sync_playwright() as pw:
    ...
    page.click("tr[data-id='00000000-0000-4000-8000-000000000005'] .qlink"); page.wait_for_function("document.querySelector('.preview .media-note') !== null")
    check("audio is noted in the preview", "Audio" in page.inner_text(".preview .media-note"))
    check("edit and add are links to the editor", (page.get_attribute(".preview a:has-text('Edit')", "href") or "").startswith("#/questions/edit/00000000-0000-4000-8000-000000000005") and page.get_attribute("a:has-text('Add question')", "href") == "#/questions/new")
