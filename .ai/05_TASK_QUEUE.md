...
**Next: TASK-010 (student join + exam engine)** — the exam engine's teacher side is live-verified; students joining by code is the next milestone. Before that, consider the small owner steps in `docs/verification-checklist.md` (disable public sign-up — ISSUE-007 — and the live media upload check, TASK-007).
