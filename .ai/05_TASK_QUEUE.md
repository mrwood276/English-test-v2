...
**Next recommended: the TASK-012 remainder** (XLSX/PDF exports) or **TASK-014** (dashboard/UX polish) — both are ordinary feature work with no owner dependency. Release is down to the **three owner-only items** below — see `08_HANDOFF.md` RELEASE STATUS.
...
- Remaining: XLSX/PDF exports. CSV is implemented; Questions statistics lazy-load existing staff reports and Classes statistics use the overview payload. No schema migration was needed.
