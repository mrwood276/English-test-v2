...
| Item | Value |
|---|---|
| Last updated | 2026-09-24 (GitHub Copilot — added Classes statistics tab) |
...
| Current focus | **TASK-013 and TASK-022 complete.** Monitor hub + per-exam live table + session timeline (`monitor_e2e.py` 30/30), exam-wide add time, and live browser evidence are complete. TASK-012 now has tested CSV and Classes statistics; Questions statistics and XLSX/PDF remain. Release to `main` still not done; three owner-only items remain. |
