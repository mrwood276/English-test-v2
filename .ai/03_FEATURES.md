...
| F-14 | Audit log viewer (built), scheduled purge jobs (built), backups, notifications, user management | **PARTIAL — viewer LIVE-VERIFIED (2026-09-25); scheduled jobs LIVE-VERIFIED (2026-09-26)** | ACTIVE | Viewer and the three `pg_cron` jobs are live and verified (`docs/sql-jobs.md`); backups/notifications/user management not built |
...
- Not started (rest of TASK-015): backups (manual + scheduled), notifications (dashboard + email — needs the owner to choose a provider, DEC-017), user management.
