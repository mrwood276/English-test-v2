...
| F-12 | Essay grading, results, statistics, exports | CORE COMPLETE (XLSX/PDF exports remain) | ACTIVE | LIVE-VERIFIED (core, 2026-09-24); statistics TESTED |
...
- Not built (TASK-012 remainder): XLSX/PDF exports. The Questions and Classes tabs now show question accuracy/most-chosen answers and merged-class averages from existing staff results payloads. CSV export is also available.
